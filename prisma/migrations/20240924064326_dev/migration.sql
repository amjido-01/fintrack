...
INSERT INTO "new_Income" ("amount", "category", "createdAt", "customCategory", "date", "description", "id", "incomeSource", "userId", "workspaceId") SELECT "amount", "category", "createdAt", "customCategory", "date", "description", "id", "incomeSource", "userId", "workspaceId" FROM "Income";
DROP TABLE "Income";
